...
const week1 = [
  {
    ...
    exercises: [
      ...
      {
        exercise:
          "Jumping jacks to maximum height (jumps  as high as possible)",
  ...
  },
  {
    ...
    exercises: [
      {
        exercise:
          "Deadlift (sumo or conventional, whichever is more comfortable)",
      ...
      {
        exercise: "Dumbbell row on bench",
      ...
      {
        exercise: "Triceps extensions with cable machine",
