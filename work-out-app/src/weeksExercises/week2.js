...
const week2 = [
  {
    ...
    exercises: [
      ...
      {
        exercise: "6. Standing barbell shoulder press",
  ...
  },
  {
    ...
    exercises: [
      {
        exercise: "1. Box deadlift( 3-5 cm height)-(a box at the legs back)",
